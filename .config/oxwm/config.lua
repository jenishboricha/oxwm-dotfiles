...
-- Brightness Control
oxwm.key.bind({}, "XF86MonBrightnessUp", oxwm.spawn({"/home/jb/.local/bin/brightness-up"}))
oxwm.key.bind({}, "XF86MonBrightnessDown", oxwm.spawn({"/home/jb/.local/bin/brightness-down"}))

-- Audio Control
oxwm.key.bind({}, "XF86AudioRaiseVolume", oxwm.spawn({"/home/jb/.local/bin/volume-up"}))
oxwm.key.bind({}, "XF86AudioLowerVolume", oxwm.spawn({"/home/jb/.local/bin/volume-down"}))
oxwm.key.bind({}, "XF86AudioMute", oxwm.spawn({"/home/jb/.local/bin/volume-mute"}))
...
oxwm.autostart("feh --bg-scale Downloads/wall_2.webp")
